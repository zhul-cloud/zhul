...
public enum ErrorCode {
    ...
    A0706("A0706", "用户导入文件模版错误"),
    A0707("A0707", "用户导入文件数据为空"),
    A0708("A0708", "用户导入文件解析异常"),
    ...
    C0510("C0510", "分布式id服务出错"),
    C0511("C0511", "雪花模式 id服务失败"),
    C0512("C0512", "号段模式 id服务失败"),
    ...
    public static ErrorCode getEnum(String code) {
        for (ErrorCode el : ErrorCode.values()) {
            if (el.code == code) {
                return el;
            }
        }
