...
spring.shardingsphere.rules.sharding.sharding-algorithms.table-inline.props.algorithm-expression=t_order_$->{warehouse_code}
spring.shardingsphere.rules.sharding.tables.t_order.actual-data-nodes=zhul-ds.t_order_D021,zhul-ds.t_order_D023
spring.shardingsphere.rules.sharding.tables.t_order.table-strategy.standard.sharding-column=warehouse_code
...
[初始化脚本](../../src/main/resources/sql/hint-sharding-table-schema.sql)
